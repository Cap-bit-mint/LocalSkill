...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/Cap-bit-mint/LocalSkill)

**🚀 线上访问：** https://localskill.vercel.app
...
> Vercel 会自动拉取代码、 安装依赖、执行构建。部署完成后在 Vercel Project Settings 中配置以下环境变量即可。
...
# AI（Claude / MiniMax 中转站）
CLAUDE_API_KEY=sk-xxx
CLAUDE_BASE_URL=https://mimimax.cn/v1
```
...
- 官网：**https://localskill.vercel.app**
